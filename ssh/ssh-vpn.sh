...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Fv-store/not/main/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/Fv-store/not/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O menu-vless "https://raw.githubusercontent.com/Fv-store/not/xray/main/menu/menu-vless.sh"
...
wget -O certv2ray "https://raw.githubusercontent.com/Fv-store/not/main/certv2ray.sh"
...
# change port
wget -O port-ssl "https://raw.githubusercontent.com/Fv-store/not/main/port/port-ssl.sh"
wget -O port-ovpn "https://raw.githubusercontent.com/Fv-store/not/main/port/port-ovpn.sh"


wget -O xp "https://raw.githubusercontent.com/Fv-store/not/main/ssh/xp.sh"
wget -O acs-set "https://raw.githubusercontent.com/Fv-store/not/main/acs-set.sh"

wget -O sshws "https://raw.githubusercontent.com/Fv-store/not/main/ssh/sshws.sh"
wget -O upmenu "https://raw.githubusercontent.com/Fv-store/not/main/upmenu.sh"
