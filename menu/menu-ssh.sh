...
echo ""
echo -e "${CY}┌──────────────────────────────┐${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}1${CYAN}]${CY} Create SSH Account   ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}2${CYAN}]${CY} Trial SSH Account    ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}3${CYAN}]${CY} Renew SSH Account    ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}4${CYAN}]${CY} Delete SSH Account   ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}5${CYAN}]${CY} Check User Login SSH Account ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}6${CYAN}]${CY} Member SSH Account   ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}7${CYAN}]${CY} Delete User Expired SSH Account   ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}8${CYAN}]${CY} Setting AutoKill SSH Account   ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}9${CYAN}]${CY} Check User Multi login SSH Account   ${NC}"
