...
echo ""
echo -e "${CY}┌──────────────────────────────┐${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}1${CYAN}]${CY} Create Vmess Account   ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}2${CYAN}]${CY} Trial Vmess Account    ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}3${CYAN}]${CY} Renew Vmess Account    ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}4${CYAN}]${CY} Delete Vmess Account   ${NC}"
echo -e "${CY}│${NC}${CYAN} [${WHI}5${CYAN}]${CY} Check User Login Vmess ${NC}"
