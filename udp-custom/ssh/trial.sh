...
echo -e "Payload WS"
echo -e "
GET wss://${domen}/ [protocol][crlf]Host: ${domen}[crlf]Upgrade: websocket[crlf]Connection: keep-alive[crlf][crlf]"
echo -e ""
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
echo ""
read -n 1 -s -r -p "Klik tombol apa saja untuk kembali ke menu"
menu-ssh
